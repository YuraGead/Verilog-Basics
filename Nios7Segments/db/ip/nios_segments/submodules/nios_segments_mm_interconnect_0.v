// nios_segments_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios_segments_mm_interconnect_0 (
		...
		output wire [1:0]  segm_s1_address,                       //                         segm_s1.address
		output wire        segm_s1_write,                         //                                .write
		input  wire [31:0] segm_s1_readdata,                      //                                .readdata
		output wire [31:0] segm_s1_writedata,                     //                                .writedata
		output wire        segm_s1_chipselect,                    //                                .chipselect
	...
	wire  [18:0] sysid_control_slave_agent_m0_address;                                      // sysid_control_slave_agent:m0_address -> sysid_control_slave_translator:uav_address
	...
	wire  [95:0] sysid_control_slave_agent_rf_source_data;                                  // sysid_control_slave_agent:rf_source_data -> sysid_control_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] sysid_control_slave_agent_rsp_fifo_out_data;                               // sysid_control_slave_agent_rsp_fifo:out_data -> sysid_control_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [18:0] onchip_mem_s1_agent_m0_address;                                            // onchip_mem_s1_agent:m0_address -> onchip_mem_s1_translator:uav_address
	...
	wire  [94:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> switch_s1_agent:cp_data
	...
	wire  [31:0] segm_s1_agent_m0_readdata;                                                 // segm_s1_translator:uav_readdata -> segm_s1_agent:m0_readdata
	wire         segm_s1_agent_m0_waitrequest;                                              // segm_s1_translator:uav_waitrequest -> segm_s1_agent:m0_waitrequest
	wire         segm_s1_agent_m0_debugaccess;                                              // segm_s1_agent:m0_debugaccess -> segm_s1_translator:uav_debugaccess
	wire  [18:0] segm_s1_agent_m0_address;                                                  // segm_s1_agent:m0_address -> segm_s1_translator:uav_address
	wire   [3:0] segm_s1_agent_m0_byteenable;                                               // segm_s1_agent:m0_byteenable -> segm_s1_translator:uav_byteenable
	wire         segm_s1_agent_m0_read;                                                     // segm_s1_agent:m0_read -> segm_s1_translator:uav_read
	wire         segm_s1_agent_m0_readdatavalid;                                            // segm_s1_translator:uav_readdatavalid -> segm_s1_agent:m0_readdatavalid
	wire         segm_s1_agent_m0_lock;                                                     // segm_s1_agent:m0_lock -> segm_s1_translator:uav_lock
	wire  [31:0] segm_s1_agent_m0_writedata;                                                // segm_s1_agent:m0_writedata -> segm_s1_translator:uav_writedata
	wire         segm_s1_agent_m0_write;                                                    // segm_s1_agent:m0_write -> segm_s1_translator:uav_write
	wire   [2:0] segm_s1_agent_m0_burstcount;                                               // segm_s1_agent:m0_burstcount -> segm_s1_translator:uav_burstcount
	wire         segm_s1_agent_rf_source_valid;                                             // segm_s1_agent:rf_source_valid -> segm_s1_agent_rsp_fifo:in_valid
	wire  [95:0] segm_s1_agent_rf_source_data;                                              // segm_s1_agent:rf_source_data -> segm_s1_agent_rsp_fifo:in_data
	wire         segm_s1_agent_rf_source_ready;                                             // segm_s1_agent_rsp_fifo:in_ready -> segm_s1_agent:rf_source_ready
	wire         segm_s1_agent_rf_source_startofpacket;                                     // segm_s1_agent:rf_source_startofpacket -> segm_s1_agent_rsp_fifo:in_startofpacket
	wire         segm_s1_agent_rf_source_endofpacket;                                       // segm_s1_agent:rf_source_endofpacket -> segm_s1_agent_rsp_fifo:in_endofpacket
	wire         segm_s1_agent_rsp_fifo_out_valid;                                          // segm_s1_agent_rsp_fifo:out_valid -> segm_s1_agent:rf_sink_valid
	wire  [95:0] segm_s1_agent_rsp_fifo_out_data;                                           // segm_s1_agent_rsp_fifo:out_data -> segm_s1_agent:rf_sink_data
	wire         segm_s1_agent_rsp_fifo_out_ready;                                          // segm_s1_agent:rf_sink_ready -> segm_s1_agent_rsp_fifo:out_ready
	wire         segm_s1_agent_rsp_fifo_out_startofpacket;                                  // segm_s1_agent_rsp_fifo:out_startofpacket -> segm_s1_agent:rf_sink_startofpacket
	wire         segm_s1_agent_rsp_fifo_out_endofpacket;                                    // segm_s1_agent_rsp_fifo:out_endofpacket -> segm_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> segm_s1_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> segm_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // segm_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> segm_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> segm_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> segm_s1_agent:cp_endofpacket
	...
	wire  [94:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [94:0] switch_s1_agent_rp_data;                                                   // switch_s1_agent:rp_data -> router_005:sink_data
	...
	wire         segm_s1_agent_rp_valid;                                                    // segm_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] segm_s1_agent_rp_data;                                                     // segm_s1_agent:rp_data -> router_006:sink_data
	wire         segm_s1_agent_rp_ready;                                                    // router_006:sink_ready -> segm_s1_agent:rp_ready
	wire         segm_s1_agent_rp_startofpacket;                                            // segm_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         segm_s1_agent_rp_endofpacket;                                              // segm_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         segm_s1_agent_rdata_fifo_src_valid;                                        // segm_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] segm_s1_agent_rdata_fifo_src_data;                                         // segm_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         segm_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_004:in_0_ready -> segm_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> segm_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> segm_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // segm_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> segm_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (segm_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (segm_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (segm_s1_agent_m0_read),                 //                         .read
		.uav_write              (segm_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (segm_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (segm_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (segm_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (segm_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (segm_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (segm_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (segm_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (segm_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (segm_s1_write),                         //                         .write
		.av_readdata            (segm_s1_readdata),                      //                         .readdata
		.av_writedata           (segm_s1_writedata),                     //                         .writedata
		.av_chipselect          (segm_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (segm_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (segm_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (segm_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (segm_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (segm_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (segm_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (segm_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (segm_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (segm_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (segm_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (segm_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (segm_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (segm_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (segm_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (segm_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (segm_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (segm_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (segm_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (segm_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (segm_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (segm_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (segm_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (segm_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (segm_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (segm_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (segm_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),        //                .error
		.rdata_fifo_src_ready    (segm_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (segm_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (segm_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) segm_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                            //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (segm_s1_agent_rf_source_data),             //        in.data
		.in_valid          (segm_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (segm_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (segm_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (segm_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (segm_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (segm_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (segm_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (segm_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (segm_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	nios_segments_mm_interconnect_0_router router (
	...
	nios_segments_mm_interconnect_0_router_001 router_001 (
	...
	nios_segments_mm_interconnect_0_router_002 router_002 (
	...
	nios_segments_mm_interconnect_0_router_003 router_003 (
	...
	nios_segments_mm_interconnect_0_router_003 router_004 (
	...
	nios_segments_mm_interconnect_0_router_002 router_005 (
	...
	nios_segments_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (segm_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (segm_s1_agent_rp_valid),                //          .valid
		.sink_data          (segm_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (segm_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (segm_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_segments_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	nios_segments_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (segm_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (segm_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (segm_s1_agent_rdata_fifo_src_ready),    //         .ready
